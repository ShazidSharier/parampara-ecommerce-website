    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal" href="{{ route('dashboard') }}">
                <img src="{{ asset('/') }}admin/assets/images/brand/logo-3.png" height="1000" width="1000" class="header-brand-img desktop-logo" alt="logo">
                <img src="{{ asset('/') }}admin/assets/images/brand/logo-3.png" height="1000" width="1000" class="header-brand-img light-logo1" alt="logo">
            </a>
            <!-- LOGO -->
...
{{--                            </div>--}}
                            ...
                            <div class="dropdown d-md-flex profile-1">
                                <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
                                                ...
                                                @else
                                                    <span>
                                                        <img src="{{ asset('/') }}admin/assets/images/brand/logo-3.png" alt="profile-user"
                                                             class="avatar  profile-user brround cover-image">
                                                    </span>
                                                @endif
