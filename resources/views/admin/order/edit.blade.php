                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" name="courier_id">
                                            ...
                                            <option value="1" @selected($order->courier_id == 1)>Sundarban</option>
                                            <option value="2" @selected($order->courier_id == 2)>Korotoa</option>
                                            <option value="3" @selected($order->courier_id == 3)>Pathao</option>
                                            <option value="4" @selected($order->courier_id == 4)>SA Poribahan</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-4">
