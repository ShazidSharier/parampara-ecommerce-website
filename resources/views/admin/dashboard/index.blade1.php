                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <p class="text-muted mb-0 mt-2 fs-12"><span class="icn-box text-success fw-semibold fs-13 me-1"><i class='fa fa-long-arrow-up'></i>42%</span>since last month</p>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <p class="text-muted mb-0 mt-2 fs-12"><span class="icn-box text-danger fw-semibold fs-13 me-1"><i class='fa fa-long-arrow-down'></i>12%</span>since last month</p>
                            </div>
                            <div class="col col-auto top-icn dash">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <p class="text-muted mb-0 mt-2 fs-12"><span class="icn-box text-success fw-semibold fs-13 me-1"><i class='fa fa-long-arrow-up'></i>27%</span>since last month</p>
                            </div>
                            <div class="col col-auto top-icn dash">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <p class="text-muted mb-0 mt-2 fs-12"><span class="icn-box text-success fw-semibold fs-13 me-1"><i class='fa fa-long-arrow-up'></i>9%</span>since last month</p>
                            </div>
                            <div class="col col-auto top-icn dash">
